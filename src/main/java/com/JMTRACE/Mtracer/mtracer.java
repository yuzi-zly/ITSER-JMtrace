...
public class mtracer {
    ...
    private static void getObjectTypeHashCode(MethodVisitor mv, String descriptor){
        mv.visitInsn(DUP);
    ...
    public static void traceStaticWrite(MethodVisitor mv, String ownername, String descriptor){
        /*  打印W，ThreadID */
        final String R_W = "W";
        ...
        if(descriptor.startsWith("[") || descriptor.startsWith("L")){
            /* Arrays or Object */
            getObjectTypeHashCode(mv, descriptor);
        }
        else{
            /* Base Type */
    ...
    public static void traceStaticRead(MethodVisitor mv, String ownername, String descriptor){
        /*  打印R，ThreadID */
        final String R_W = "R";
        mv.visitFieldInsn(GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");
        mv.visitMethodInsn(INVOKESTATIC, "java/lang/Thread", "currentThread", "()Ljava/lang/Thread;", false);
